                ...
                <div className="">
                    ...
                    <div>
                        <div className="flex flex-col lg:flex-row items-center justify-between pb-32">
                            <p className="text-gray-300 font-sans py-3 lg:mr-5 lg:text-xl">I am a creative person who loves technology. I have interests in Agile Project Management, Digital Marketing, Front-End Web Development, and User Experience Design. I expect and desire to work in an environment that facilitates career and personal development and be part of a team with members of diverse backgrounds. My core values are <span className="text-yellow-300">Creativity, Dedication, Responsibility, and Integrity.</span></p>
                            <p className="text-gray-300 font-sans py-3 lg:ml-5 lg:text-xl">My major career goal is to become a <span className="text-yellow-300">Digital Product Manager.</span> I plan to adopt a combination of technology, creativity, and my knowledge of business/management to implement meaningful projects that solve customer problems. While trying to balance business needs with those of end-users, I understand the need to ensure efficient utilisation of time and resources, be proactive and result-driven, have a positive attitude and be a team leader. </p>
                        </div>
